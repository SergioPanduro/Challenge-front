                    ...
                    unTodo.map(element => {
                       return( 
                           <>
                                ...
                                <Select placeholder={element.completed == 1 ? "Status: Completed" : "Status: Pending"} style={{ width: 200 }} onChange={(e)=>{completedEdition(element.id,e)}}>
                                ...
                                {
                                    element.edit ? <p style={{color:"black",fontWeight:400,fontSize:13}}>Editado el {element.edit}, <br></br> by {element.name} </p> : <p style={{color:"black",fontWeight:400,fontSize:13}}>By {element.name} </p>
                                }
